...
def validate_before_edit(file_path: str, old_text: str) -> Tuple[bool, str]:
    ...
    if ratio >= 0.9:
        return False, f"Close match ({ratio:.1%}) but not exact. Matched: {matched[:80]}..."
...
def edit_with_fallback(file_path: str, old_text: str, new_text: str, force: bool = False) -> bool:
    """
